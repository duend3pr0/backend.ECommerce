...
import CartsMongooseRepository from "./data/repositories/mongoose/cartMongooseRepository.js";
...
if(process.env.DB === 'MongooseAdapter')
{
  ...
  container.register('CartsRepository', asClass(CartsMongooseRepository), { lifetime: Lifetime.SINGLETON });
}
